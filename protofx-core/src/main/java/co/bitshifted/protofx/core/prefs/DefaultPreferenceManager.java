...
/**
 * Standard implementation of {@link PreferenceManager}. It uses Java standard Preferences API to persist preference values.
 */
public class DefaultPreferenceManager implements PreferenceManager {
    ...
    @Override
    public LongPreferenceEntry getLongPreference(String name, Long defaultValue) {
        return getLongPreference(applicationConfig.defaultPreferenceRootNode(), name, defaultValue);
    }@Override
    ...
    @Override
    public FloatPreferenceEntry getFloatPreference(String name, Float defaultValue) {
        return getFloatPreference(applicationConfig.defaultPreferenceRootNode(), name, defaultValue);
    }@Override
